<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      <a class="nav-link active" aria-current="page" href="Telainicialusuario.php">Início</a>
      <a class="nav-link active" href="detalhespedido.php">Pedidos</a>
      <a class="nav-link active" href="informacoes.php">Informações</a>
      <a class="nav-link active" href="dadosusuario.php">Perfil</a>
      <a class="nav-link active" href="pedidoalternativo.php">Pedido Alternativo</a>
